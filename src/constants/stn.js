...
export let seasons = new Map([
  ...
  ['Feb',{title:'February',interval:[1,0],duration:1,maxmissing:3,smonth:1}],
  ['Mar',{title:'March',interval:[1,0],duration:1,maxmissing:3,smonth:1}],
  ['Apr',{title:'April',interval:[1,0],duration:1,maxmissing:3,smonth:1}],
  ['May',{title:'May',interval:[1,0],duration:1,maxmissing:3,smonth:1}],
  ['Jun',{title:'June',interval:[1,0],duration:1,maxmissing:3,smonth:1}],
  ['Jul',{title:'July',interval:[1,0],duration:1,maxmissing:3,smonth:1}],
  ['Aug',{title:'August',interval:[1,0],duration:1,maxmissing:3,smonth:1}],
  ['Sep',{title:'September',interval:[1,0],duration:1,maxmissing:3,smonth:1}],
  ['Oct',{title:'October',interval:[1,0],duration:1,maxmissing:3,smonth:1}],
  ['Nov',{title:'November',interval:[1,0],duration:1,maxmissing:3,smonth:1}],
  ['Dec',{title:'December',interval:[1,0],duration:1,maxmissing:3,smonth:1}],
]);
